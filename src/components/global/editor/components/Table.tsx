...
const TableComponent =({
    ...
    if(isPreview){
        <div className="w-full ovrflow-x-auto text-xs">
                                ...
                                >   
                            {
                                row.map((cell,colIndex)=>(
                                    <React.Fragment key={colIndex}>
                                        ...
                                        onResize={(size)=>handleresizeCol(colIndex,size)} className="w-full h-full min-h-90"
                                        >
                                            ...
                                            focus:ring-blue-500 roundeed-md
                                            "
